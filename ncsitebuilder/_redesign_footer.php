...
<footer class="site-footer">
	<div class="footer-inner">
		<div>
			...
			<div class="footer-social" aria-label="Follow Barkly on social media">
				<span class="footer-social-label">Follow us</span>
				<a href="https://www.instagram.com/barklyfashion/" target="_blank" rel="noopener noreferrer" aria-label="Barkly Fashion on Instagram">
					<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true"><path d="M12 2.2c3.2 0 3.6 0 4.85.07 1.17.05 1.8.25 2.23.42.56.22.96.48 1.38.9.42.42.68.82.9 1.38.17.42.36 1.06.42 2.23.06 1.26.07 1.64.07 4.85s0 3.6-.07 4.85c-.06 1.17-.25 1.8-.42 2.23-.22.56-.48.96-.9 1.38-.42.42-.82.68-1.38.9-.43.17-1.06.36-2.23.42-1.26.06-1.64.07-4.85.07s-3.6 0-4.85-.07c-1.17-.06-1.8-.25-2.23-.42-.56-.22-.96-.48-1.38-.9-.42-.42-.68-.82-.9-1.38-.17-.43-.36-1.06-.42-2.23C2.2 15.6 2.2 15.22 2.2 12s0-3.6.07-4.85c.06-1.17.25-1.8.42-2.23.22-.56.48-.96.9-1.38.42-.42.82-.68 1.38-.9.42-.17 1.06-.36 2.23-.42C8.4 2.21 8.78 2.2 12 2.2zm0 1.95c-3.16 0-3.53.01-4.77.07-1.07.05-1.65.23-2.04.38-.51.2-.88.44-1.27.83-.39.39-.62.76-.83 1.27-.15.39-.33.97-.38 2.04-.06 1.24-.07 1.6-.07 4.77s0 3.53.07 4.77c.05 1.07.23 1.65.38 2.04.2.51.44.88.83 1.27.39.39.76.62 1.27.83.39.15.97.33 2.04.38 1.24.06 1.6.07 4.77.07s3.53 0 4.77-.07c1.07-.05 1.65-.23 2.04-.38.51-.2.88-.44 1.27-.83.39-.39.62-.76.83-1.27.15-.39.33-.97.38-2.04.06-1.24.07-1.6.07-4.77s0-3.53-.07-4.77c-.05-1.07-.23-1.65-.38-2.04-.2-.51-.44-.88-.83-1.27-.39-.39-.76-.62-1.27-.83-.39-.15-.97-.33-2.04-.38-1.24-.06-1.6-.07-4.77-.07zm0 3.32a4.53 4.53 0 1 1 0 9.06 4.53 4.53 0 0 1 0-9.06zm0 1.95a2.58 2.58 0 1 0 0 5.16 2.58 2.58 0 0 0 0-5.16zm4.75-2.16a1.06 1.06 0 1 1 0 2.12 1.06 1.06 0 0 1 0-2.12z"/></svg>
				</a>
				<a href="https://www.facebook.com/profile.php?id=61575475840631" target="_blank" rel="noopener noreferrer" aria-label="Barkly Fashion on Facebook">
					<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true"><path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5 3.66 9.15 8.44 9.94v-7.03H7.9v-2.91h2.54V9.85c0-2.51 1.49-3.9 3.77-3.9 1.09 0 2.24.2 2.24.2v2.47h-1.26c-1.24 0-1.63.78-1.63 1.57v1.88h2.78l-.45 2.91h-2.34V22c4.78-.79 8.45-4.94 8.45-9.94z"/></svg>
				</a>
				<a href="https://www.linkedin.com/company/barkly-fashion" target="_blank" rel="noopener noreferrer" aria-label="Barkly Fashion on LinkedIn">
