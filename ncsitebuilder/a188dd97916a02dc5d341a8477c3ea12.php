...
<head>
	...
	<?php echo isset($sitemapUrls) ? (generateCanonicalUrl($sitemapUrls)."\n") : ""; ?>	
					...
					<meta name="description" content="<?php echo htmlspecialchars((isset($seoDescription) && $seoDescription !== "") ? $seoDescription : "BarklyFashion - Pawsitively Elegant Attire For Dogs"); ?>" />
			<meta name="keywords" content="<?php echo htmlspecialchars((isset($seoKeywords) && $seoKeywords !== "") ? $seoKeywords : "dog apparel,pet clothing,Indian dog fashion,stylish dog wear,dog sweaters,dog jackets,pet boutique,premium dog clothing,trendy dog outfits,durable dog apparel,affordable pet wear,fashionable dog clothing,custom dog outfits,dog fashion online,pet accessories India"); ?>" />
	...
	<!-- Facebook Open Graph -->
		<meta property="og:title" content="<?php echo htmlspecialchars((isset($seoTitle) && $seoTitle !== "") ? $seoTitle : "BarklyFashion"); ?>" />
			<meta property="og:description" content="<?php echo htmlspecialchars((isset($seoDescription) && $seoDescription !== "") ? $seoDescription : "BarklyFashion - Pawsitively Elegant Attire For Dogs"); ?>" />
...
</div><div id="a188dd977fcf06a35aeeedb300e96446" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"><div id="a188dd977fcf0750c24e084ca7a036f2" class="wb_element wb_text_element" data-plugin="TextArea" style=" line-height: normal;"><p class="wb-stl-normal" style="text-align: justify;">At Barkly Fashion, we celebrate the charm and style of every canine companion. As a premier Indian pet apparel brand, we craft exquisite dog clothing that blends comfort with the latest trends. Our collection is designed to keep your furry friend looking fabulous all year round.</p>
<p class="wb-stl-normal" style="text-align: justify;">Driven by passion and quality, our mission is to enhance the bond between you and your pet through fashionable, durable, and affordable apparel. Explore our range and dress your dog in the finest pet wear available online.</p>
</div><div id="a188dd977fcf083f63308fdfdd2b203e" class="wb_element wb-layout-element" data-plugin="LayoutElement"><div class="wb_content wb-layout-vertical"><div id="a188dd977fcf0931ef3f581968661969" class="wb_element wb_text_element" data-plugin="TextArea" style=" line-height: normal;"><h2 class="wb-stl-heading2" style="text-align: left;">Exclusive Dog Apparel</h2>
</div><div id="a188dd977fcf0a3de0a228903d03054d" class="wb_element wb_text_element" data-plugin="TextArea" style=" line-height: normal;"><p class="wb-stl-normal" style="text-align: justify;">Barkly Fashion offers a curated selection of stylish dog wear, from cozy sweaters to vibrant jackets, perfect for every season and occasion. Our pet boutique features handpicked designs that combine Indian craftsmanship with modern pet fashion.</p>
<p class="wb-stl-normal" style="text-align: justify;">We believe every dog deserves to strut in style. Browse our online catalog to find the perfect outfit that matches your pet’s personality and comfort needs. Experience premium quality and trendsetting designs with Barkly Fashion.</p>
