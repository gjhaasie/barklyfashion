...
class PHPMailer
{
    ...
    protected static function isShellSafe($string)
    {
        //Future-proof
        if (
            (function_exists('escapeshellcmd') && escapeshellcmd($string) !== $string)
    ...
    protected function mailSend($header, $body)
    {
        ...
        if (!empty($this->Sender) && static::validateAddress($this->Sender)) {
            ...
            if (function_exists('ini_set')) @ini_set('sendmail_from', $this->Sender);
        }
        $result = false;
        ...
        if (isset($old_from)) {
            if (function_exists('ini_set')) @ini_set('sendmail_from', $old_from);
        }
        if (!$result) {
